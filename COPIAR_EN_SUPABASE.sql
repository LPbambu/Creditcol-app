-- CREDITCOL Database Setup Script (SAFE TO RE-RUN)
...
DROP TRIGGER IF EXISTS trigger_updated_at ON public.excel_uploads;
CREATE TRIGGER trigger_updated_at BEFORE UPDATE ON public.excel_uploads FOR EACH ROW EXECUTE FUNCTION update_updated_at();

DROP TRIGGER IF EXISTS trigger_updated_at ON public.message_templates;
CREATE TRIGGER trigger_updated_at BEFORE UPDATE ON public.message_templates FOR EACH ROW EXECUTE FUNCTION update_updated_at();

DROP TRIGGER IF EXISTS trigger_updated_at ON public.campaigns;
CREATE TRIGGER trigger_updated_at BEFORE UPDATE ON public.campaigns FOR EACH ROW EXECUTE FUNCTION update_updated_at();

DROP TRIGGER IF EXISTS trigger_updated_at ON public.messages;
CREATE TRIGGER trigger_updated_at BEFORE UPDATE ON public.messages FOR EACH ROW EXECUTE FUNCTION update_updated_at();

DROP TRIGGER IF EXISTS trigger_updated_at ON public.whatsapp_config;
CREATE TRIGGER trigger_updated_at BEFORE UPDATE ON public.whatsapp_config FOR EACH ROW EXECUTE FUNCTION update_updated_at();
